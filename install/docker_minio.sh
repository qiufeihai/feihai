...
add_cmd_arg_prompt "请输入SECRET_KEY" "-e MINIO_SECRET_KEY={{feihai}}" 
add_cmd_arg_prompt "请输入数据目录" "-v {{/mnt/data}}:/data" 
add_cmd_arg_prompt "请输入配置目录" "-v {{/mnt/config}}:/root/.minio" 
